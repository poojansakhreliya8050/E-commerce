...
const OrderCard = ({ order }) => {
  ...
  return (
    <div className="flex w-[32%] relative  text-gray-900 antialiased">
      <div>
        <div className="overflow-hidden lg:w-96 lg:h-56 rounded-lg">
          <img src={order?.items[0]?.item?.img} alt=" random imgee" className=" w-full h-full rounded-lg object-cover  hover:scale-110 shadow-md transition-all duration-300" />
        </div>
