...
//   const user = useSelector((state) => state.userData.user);
  ...
  return (
    <div className='ml-40 flex justify-center items-center w-screen h-screen bg-white  overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none'>

                    <div className="w-full p-8  my-4 md:px-12 lg:w-9/12 lg:pl-20 lg:pr-40 mr-auto rounded-2xl shadow-2xl">
                        <div className="flex">
                            <h1 className="font-bold uppercase text-5xl">ADD PRODUCT</h1>
                            <button type="button" onClick={() => {setShowModel(false);setProductId(null);}}className="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center">
